...
#     encMessage = fernet.decrypt(password).decode()
#     print(encMessage)
#     # cpassword = fernet.encrypt(t6.get().encode())
#     print(email, firstname, lastname, username, password)

#     add_page = ("INSERT INTO lloogg "
#                 "(first_name, last_name, username, email, password) "
#                 "VALUES (%s, %s, %s, %s, %s)")
#     data_page = (firstname, lastname, username, email, password)
...
#     elif ('@' not in email and password and lastname and username and firstname != ""):
#         l7.place(x=150, y=370)
#         l7.config(text='Invalid Email', fg="red")

#     elif (username and '@' in email and password and firstname != ""):
...
#     'Bahnschrift SemiBold', 18), fg="#340744", bg='white')
# l1 = Label(r, text="First name", font=(
#     'Times New Roman', 13), fg="#340744", bg='white')
# t1 = Entry(r, bd=5, font=('Times New Roman', 13), fg="#81599F", bg='white')
# l2 = Label(r, text="Last name", font=(
#     'Times New Roman', 13), fg="#340744", bg='white')
# t2 = Entry(r, bd=5, font=('Times New Roman', 13), fg="#81599F", bg='white')
# l3 = Label(r, text="Username", font=(
#     'Times New Roman', 13), fg="#340744", bg='white')
# t3 = Entry(r, bd=5, font=('Times New Roman', 13), fg="#81599F", bg='white')
# l4 = Label(r, text="Email", font=(
#     'Times New Roman', 13), fg="#340744", bg='white')
# t4 = Entry(r, bd=5, font=('Times New Roman', 13), fg="#81599F", bg='white')
# l5 = Label(r, text="Password", font=(
#     'Times New Roman', 13), fg="#340744", bg='white')
# t5 = Entry(r, bd=5, show=None, font=(
#     'Times New Roman', 13), fg="#81599F", bg='white')
# t5 = Entry(r, bd=5, show='*', font=('Times New Roman', 13),
#            fg="#81599F", bg='white')
# l6 = Label(r, text="Confirm-Password",
#            font=('Times New Roman', 13), fg="#340744", bg='white')
# t6 = Entry(r, bd=5, show=None, font=(
#     'Times New Roman', 13), fg="#81599F", bg='white')
# t6 = Entry(r, bd=5, show='*', font=('Times New Roman', 13),
#            fg="#81599F", bg='white')
# bt = Button(r, text="Register", command=lambda: submit(), width=20, bg="#81599F",
#             activebackground="Light blue", fg="black", cursor="hand2", font=('Times New Roman', 14))
