...
t2 = Entry(r, bd=5, show='*', font=('TimesNewRoman', 13),
           bg='white', width=35, fg='#16488F')
d = Button(r, text='Login', command=submit, width=35, bg="#0B1F65",
...
s1 = Button(r, text="Register", command=register, width=35, bg="#0B1F65",
            activebackground="#16488F", fg="white", cursor="hand2", font='TimesNewRoman')
image = Image.open("D:/sahisayyed/project-login-Page/images/login.webp")
